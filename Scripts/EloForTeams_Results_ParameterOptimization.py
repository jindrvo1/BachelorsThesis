...
# Results from parameter optimization to save computing time
...
for i in range(0, 2):
    ...
    for row in matches_fetch.fetchall():
        ...
        if len(team1_logistic) == 11 and len(team2_logistic) == 11:
            ...
            if e1_l > 0.6 and score == 1 or e1_l < 0.4 and score == 0 or e1_l >= 0.4 and e1_l <= 0.6 and score == 0.5:
        ...
        if len(team1_normal) == 11 and len(team2_normal) == 11:
            ...
            if e1_n > 0.6 and score == 1 or e1_n < 0.4 and score == 0 or e1_n >= 0.4 and e1_n <= 0.6 and score == 0.5:
                predicted_normal += 1
